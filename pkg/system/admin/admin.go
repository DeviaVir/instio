...
var endAdminHTML = `
        ...
        <footer class="row">
            <div class="col s12">
                <p class="center-align">Powered by &copy; Instio &nbsp;&vert;&nbsp; open-sourced by <a target="_blank" href="https://github.com/DeviaVir/instio">DeviaVir</a></p>
            </div>     
        </footer>
    </body>
</html>`
...
func UsersList(req *http.Request) ([]byte, error) {
    ...
    <div class="card user-management">
        ...
        <ul class="users row">
            ...
            <li class="col s9">
                {{ .Email }}
                <form enctype="multipart/form-data" class="delete-user __instio right" action="/admin/configure/users/delete" method="post">
                    <span>Delete</span>
    ...
    <script>
        $(function() {
            var del = $('.delete-user.__instio span');
