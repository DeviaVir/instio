...
func postToJSON(ns string, data url.Values) ([]byte, error) {
  ...
  // Get slugs data.
	...
	// For new item, if the content has no slug, and has no specifier, create a slug
  // check it for duplicates, and add it to our values.
