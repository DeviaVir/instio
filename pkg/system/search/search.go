...
// query package, and provides interfaces to extend Instio items with rich, full-text
// search capability.
package search
...
func MapIndex(typeName string) error {
	...
	// by Instio user if defines own SearchMapping()
...
// TypeQuery conducts a search and returns a set of Instio "targets", Type:ID pairs,
